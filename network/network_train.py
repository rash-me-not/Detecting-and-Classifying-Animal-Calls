...
def create_model(x_train_aud, x_train_acc_ch0, x_train_acc_ch1, x_train_acc_ch2, filters, gru_units, dense_neurons,
                 dropout):
    """
...
def create_model_using_z_axis(x_train_aud, x_train_acc_ch2, filters, gru_units,
                              dense_neurons,
                              dropout):
    """
    Outputs a non sequntial keras model
